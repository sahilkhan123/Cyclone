...
from scipy.sparse import hstack #TODO: 11/29/24 3:17 PM python package too old
import sys
#In bposd.css_code put this line instead of normal mod 2 line: import ldpc.mod2.mod2_numpy as mod2 IF WE RUN INTO np.all ambiguous error

##ADDED RUN BATCH STUFF
...
if (codeName == "144-12-12"):
	# [[144,12,12]]
	ell,m = 12,6
	a1,a2,a3 = 3,1,2
	b1,b2,b3 = 3,1,2
elif (codeName == "784-24-24"):
	# [[784,24,24]]
	ell,m = 28,14
	a1,a2,a3=26,6,8
	b1,b2,b3=7,9,20
elif (codeName == "72-12-6"):
	#[[72,12,6]]
	ell,m = 6,6
	a1,a2,a3=3,1,2
	b1,b2,b3=3,1,2

elif (codeName == "90-8-10"):
# Ted's code [[90,8,10]]
	ell,m = 15,3
	a1,a2,a3 = 9,1,2
	b1,b2,b3 = 0,2,7
elif (codeName == "108-8-10"):
	# [[108,8,10]]
	ell,m = 9,6
	a1,a2,a3 = 3,1,2
	b1,b2,b3 = 3,1,2
elif (codeName == "288-12-18"):
	# [[288,12,18]]
	ell,m = 12,12
	a1,a2,a3 = 3,2,7
	b1,b2,b3 = 3,1,2
	...
	assert(0)
	print("Code Name not recognized")
# code length
n = 2*m*ell
...
#72 data qubits - 36 right and left, 72 ancilla qubits 36 X and Z checks
#print("CYCLE IS", cycle)
#print("data qubits", data_qubits)
#print("X checks", Xchecks) 
#exit()
