...
for trial in range(num_trials):
	...
	"""
	with open("singleCycleCircQASMobj_90-8-10.pkl", "wb") as file:
...
print(str(error_rate) + '\t' + str(num_cycles) + '\t' + str(num_trials) + '\t' + str(bad_trials) + '\t' + str(logical_error_rate),file=open(fname,'a'))
