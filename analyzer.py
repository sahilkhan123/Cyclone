...
class Analyzer:
    ...
    def move_check(self):
        #TURNED FIDELITY STUFF OFF BY TRIPLE COMMENTS, UNDO IT TO RESTORE
        op_count = {}
        ...
        print("original sys state", self.init_map)
        q = PriorityQueue()
        ...
        while not q.empty():
            ...
            if event[1] == Schedule.Gate:
                ...
                assert 0
        print("Got to printing final stats")
        parallel_ops, percent = self.schedule.count_parallel_events()
        print("Parallel Ops", parallel_ops)
        print("Percentage of Parallelization", percent * 100, "%")
        ...
        return math.exp(log_fidelity), prog_fin_time
