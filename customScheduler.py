import sys
sys.path.insert(0, 'C:/Users/sahil/OneDrive/Desktop/Quantum Computing/QLDPC project')
import circuit_partitioning
from qiskit import QuantumCircuit
"""
from circuit_partitioning.partitioning.partitioners.dynamic.merge_dynamic_partitioner import MergeDynamicPartitioner
...
def get_cyclone_mapping_non_robust(cx_arr,ancillas, machine, machString):
    trap_amount = len(machine.traps)
    machNumberArr = machString.split("C")
    machNumber = int(machNumberArr[1])
    #assert(trap_amount == machNumber)
